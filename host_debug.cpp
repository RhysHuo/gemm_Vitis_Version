...
int main(int argc, char* argv[]) {
    ...
    DTYPE* array_a = nullptr;
    DTYPE* array_b = nullptr;
    DTYPE_OUT* array_c = nullptr;
    DTYPE_OUT* array_c_sw = nullptr;
	...
	kernelMatrixmult(S_ternary, array_a, array_b, array_c, SM, SP, S_begin, S_end);
